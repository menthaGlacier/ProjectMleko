...
dont't uses 3rd party libraries. There are no GUI, the game works in console.
...
2) The other lines will be words. Make sure each word is divided with space or new line.
Other symbols, such as commas and periods will be counted as part of word
